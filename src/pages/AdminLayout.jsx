    ...
    <>
      <style>{`
        * { box-sizing: border-box; }
        ...
        .adm-logo { width:36px; height:36px; border-radius:10px; background:linear-gradient(135deg,#f59e0b,#d97706); color:white; font-weight:800; font-size:14px; display:flex; align-items:center; justify-content:center; box-shadow:0 4px 10px rgba(245,158,11,0.35); flex-shrink:0; }
        ...
        .adm-topbar { background:white; border-bottom:1px solid #e2e8f0; padding:0 20px; height:56px; display:flex; align-items:center; justify-content:space-between; position:sticky; top:0; z-index:50; flex-shrink:0; }
        .adm-content { flex:1; padding:20px; overflow-y:auto; }

        .adm-menu-btn { display:none; border:1px solid #e2e8f0; background:white; border-radius:10px; padding:8px 10px; cursor:pointer; font-size:18px; }
        .adm-overlay { display:none; position:fixed; inset:0; background:rgba(15,23,42,0.5); z-index:40; }
        ...
        @media(max-width:768px) {
          ...
          .adm-sidebar.open { transform:translateX(0); box-shadow:4px 0 24px rgba(0,0,0,0.25); }
          .adm-menu-btn { display:inline-flex; align-items:center; justify-content:center; }
      ...
      <div className="adm-layout">
        ...
        <div className="adm-main">
          <div className="adm-topbar">
            ...
            <span style={{ fontSize:"12px", color:"#64748b", background:"#f1f5f9", padding:"5px 12px", borderRadius:"999px", fontWeight:"500", whiteSpace:"nowrap" }}>
